...
#    path('registrar/', RegistrarPerfilView.as_view(), name='registrar'),
...
#         auth_views.PasswordChangeView.as_view(template_name='usuarios/password_change.html'), name='password_change'),
#    path('password-change/done/',
#         auth_views.PasswordChangeDoneView.as_view(template_name='usuarios/password_change_done.html'), name='password_change_done'),
   # Usando a view customizada para o PasswordChange
